...
<div class="container">
<h4>เพิ่มจำนวนสินค้า</h4>
                                        <form method="POST" action="update.php">
                                            <input type="hidden" id="optupdate" name="optupdate" value="add">
                                            ...
                                            <div class="form-group">
                                                <label for="pro_stock">เพิ่ม</label>
                                                <input style="width:25%;" type="text" class="form-control" id="pro_stock" name="pro_stock" placeholder="0">
                                            </div> 

                                           
                                            <button onclick="return confirm_up()" type="sunmit" class="btn btn-danger">เพิ่ม</button>
