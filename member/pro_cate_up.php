...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="update.php">
            ...
            <div class="form-group">
                <label for="pro_note" class="control-label">หมายเหตุ
                </label>
                <input style="width:50%;" type="text" class="form-control" id="pro_note" name="pro_note" value=<?php echo "\"" . $row['pro_note'] . "\""; ?>>
            </div>
